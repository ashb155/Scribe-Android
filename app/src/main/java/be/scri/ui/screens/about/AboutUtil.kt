 ...
 * @param isConjugateApp Whether the list is being built for the Conjugate app.
...
object AboutUtil {
    ...
    fun getCommunityList(
        ...
        remember {
            ScribeItemList(
                items = buildCommunityList(context, onShareScribeClick, onWikimediaAndScribeClick,isConjugateApp),
            )
        }
